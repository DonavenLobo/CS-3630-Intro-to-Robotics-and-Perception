...
from tasks import phase2_planning
from utils import *
...
class RobotEnv:
    ...
    def update(self):
        ...
        if self.program_state == 'exploration':
            ...
            self.robbie = phase2_planning(self.robbie,self.grid)
...
if __name__ == "__main__":
    ...
    map_filename = "maps_warehouse/map_2.json"
    #  Set state 'exploration' or 'tasks'
    state = 'tasks'
